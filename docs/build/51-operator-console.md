...
- [ ] Corrections **1–68** of §22 each filed against their document with an owner. **Rows 4 and 59 block a complete `apps/web`** and are recorded as blocking. **Rows 15, 16, 17, 19, 21, and 67 are resolved.**
